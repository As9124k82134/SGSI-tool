...
app_list="InMIpay MIDrop MiLinkGlobal miPlayClient MIUIFileExplorer MIUIHealthGlobal MIUIMiPicks MIUITouchAssistantGlobal XMSFKeepekAll MIShare* MIUIYellowPage* DeviceInfo dpmserviceapp EmergencyInfo GoogleFeedback seccamservice WfdService MiuiAod MiRecycle MiPay MiRadio"
